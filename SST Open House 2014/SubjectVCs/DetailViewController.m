...
-(void)setTextAccordingToIdentifier:(NSUInteger)ident
{
    if (ident==0) {
        ...
        if (iPad)
            _imageView.image = [self imageByScalingAndCroppingForSize:CGSizeMake(768, 576) withImage:[UIImage imageNamed:@"English"]];
        else
        ...
        if (iPad)
            _imageView.image = [self imageByScalingAndCroppingForSize:CGSizeMake(768, 576) withImage:[UIImage imageNamed:@"Maths"]];
        else
        ...
        if (iPad)
            _imageView.image = [self imageByScalingAndCroppingForSize:CGSizeMake(768, 576) withImage:[UIImage imageNamed:@"Science"]];
        else
        ...
        if (iPad)
            _imageView.image = [self imageByScalingAndCroppingForSize:CGSizeMake(768, 576) withImage:[UIImage imageNamed:@"IH"]];
        else
        ...
        if (iPad)
            _imageView.image = [self imageByScalingAndCroppingForSize:CGSizeMake(768, 576) withImage:[UIImage imageNamed:@"IRS"]];
        else
        ...
        if (iPad)
            _imageView.image = [self imageByScalingAndCroppingForSize:CGSizeMake(768, 576) withImage:[UIImage imageNamed:@"ICT"]];
        else
